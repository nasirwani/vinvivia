...
const Header = () => {
  const items = [
    {
      label: (
        <a rel="noopener noreferrer" href="/manage-events">
          MANAGE EVENTS
        </a>
      ),
      key: "0",
    ...
    {
      label: (
        <a rel="noopener noreferrer" href="/manage-tenants">
          MANAGE TENANTS
        </a>
      ),
      key: "1",
    ...
    {
      label: (
        <a rel="noopener noreferrer" href="/manage-roles">
          MANAGE ROLES
        </a>
      ),
      key: "2",
  ...
  return (
    <div className="header-container">
      <div className="headercontent">
        ...
        <div className="logoname">vinivia</div>
        <Dropdown
          className="dropdown"
          menu={{
            items,
        ...
        <div className="header-user-info">
          <div className="user-logo">
            <img
              src="https://cdn.vinivia.events/1662631109907grjMXl50M9.jpg"
              alt="user-logo"
            />
          </div>
